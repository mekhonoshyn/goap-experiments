...
(async () => {
    ...
    class AbstractSelect extends (await BaseComponent) {
        render() {
                    ...
                    <div tabindex="0"
                       ...
                       @keydown=${selectKeydownHandler}>
                        <div class="mdc-select ${required ? 'mdc-select--required' : ''} ${showInvalidity ? 'mdc-select--invalid' : ''} ${activated ? 'mdc-select--activated' : ''} ${focused ? 'mdc-select--focused' : ''}">
                            ...
                            <awc-abstract-line-ripple></awc-abstract-line-ripple>
                        </div>
                        <p class="mdc-select-helper-text ${showInvalidity ? 'mdc-select-helper-text--validation-msg' : ''}"
                           title=${displayMessage}>${displayMessage}</p>
        ...
        onRender() {
            ...
            this.rippleElement = this.shadowRoot.querySelector('awc-abstract-line-ripple');
        ...
        static get deferredDependencies() {
            return [
                import('app/web-components/abstract-line-ripple/abstract-line-ripple-component'),
