(async () => {
    ...
    class AbstractActionButton extends (await BaseComponent) {
        render() {
            ...
            return compile`
                ...
                <include src="abstract-action-button-styles.html"></include>
                ...
                <button class="mdc-button mdc-button--raised ${this.isIconic ? 'mdc-button--no-label' : ''}"
    ...
    customElements.define('awc-abstract-action-button', AbstractActionButton);
